...
public class VMCustomerInterface extends VM implements VMCustomerInterfaceAPI {
        ...
        if (itemFound) {
            if (itemQuantity > 0) {
                if (getCurrentBalance() >= itemPrice) {
                    ...
                    System.out.println("£" + (getCurrentBalance() - itemPrice) + " deposited in total in refundtray.");
